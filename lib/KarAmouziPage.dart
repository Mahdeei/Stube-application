                        ...
                        new Row(
                          children: <Widget>[
                            new Padding(
                              ...
                              child: new Text('شرکت ایران سرور',overflow: TextOverflow.ellipsis,maxLines: 1,style: TextStyle(fontSize: 12.0,),),),
                            new Text('|',style: TextStyle(fontSize: 18.0,fontWeight: FontWeight.bold),),
